      ...
      <div className="max-w-5xl mx-auto px-8 py-16">
            ...
            >
                ...
                >
                  ...
                  <ul className="space-y-3 text-sm" style={{ color: 'var(--ink-light)' }}>
                    <li className="flex gap-3">
                      <span className="font-bold" style={{ color: 'var(--saffron)' }}>1.</span>
                      <span>Center command establishes position</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="font-bold" style={{ color: 'var(--saffron)' }}>2.</span>
                      <span>Protective rings form outward</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="font-bold" style={{ color: 'var(--saffron)' }}>3.</span>
                      <span>Soldiers assume defensive positions</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="font-bold" style={{ color: 'var(--saffron)' }}>4.</span>
              ...
              {mode === "explain" && (
                <div className="space-y-4">
                  ...
                  >
                    <h4 className="font-bold mb-2" style={{ color: 'var(--saffron)' }}>Outer Ring</h4>
                  ...
                  >
                    <h4 className="font-bold mb-2" style={{ color: 'var(--saffron)' }}>Core Command</h4>
                    <p className="text-sm leading-relaxed" style={{ color: 'var(--ink-light)' }}>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            >
              <h3 className="font-bold text-base mb-3" style={{ color: 'var(--brass)' }}>Origins</h3>
              <p className="text-sm leading-relaxed" style={{ color: 'var(--ink-light)' }}>
            ...
            >
              <h3 className="font-bold text-base mb-3" style={{ color: 'var(--brass)' }}>Tactical Innovation</h3>
              <p className="text-sm leading-relaxed" style={{ color: 'var(--ink-light)' }}>
